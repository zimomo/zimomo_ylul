...
| refresh                 | string id     |        | 刷新指定id窗体，如果未指定id，刷新本窗体 |
...
| minimize | string id | | 最小化指定id的窗体，如果未指定id，最小化本窗体 |
| maxmize | string id | | 最大化指定id的窗体，如果未指定id，最大化本窗体 |
| restore | string id | | 还原指定id的窗体，如果未指定id，还原本窗体 |
